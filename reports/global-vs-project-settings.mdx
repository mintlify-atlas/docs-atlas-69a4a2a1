---
title: 'Global vs Project Settings'
description: 'Comprehensive comparison of which Claude Code features are global-only versus which have both global and project-level equivalents'
---
...
<Tip>
**Design principle:** Things that are *personal state* or *cross-project coordination* live globally; things that are *team-shareable project config* can live at the project level.
</Tip>
...
<Tabs>
  <Tab title="Global Scope">
    ...
    ~/.claude.json                 # GLOBAL-ONLY: MCP servers, OAuth, preferences
    ```
  </Tab>
...
<Warning>
Announced **February 5, 2026** as an experimental feature.
</Warning>

Agent Teams allow multiple Claude Code sessions to coordinate on shared work.
...
- [How to Set Up Claude Code Agent Teams - r/ClaudeCode](https://www.reddit.com/r/ClaudeCode/comments/1qz8tyy/how_to_set_up_claude_code_agent_teams_full/)
